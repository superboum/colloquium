...
Context
----------
The mathematic center of the Rennes INSA organise à mathematic conference in July 2016, which will last one week. 150 participants are awaited.   
The need is to create a web site, which will be published in Juny 2016, in order to promote et organise the conference.     
Website description
-------------
The conference's name, **IWSM** will be visible.    
