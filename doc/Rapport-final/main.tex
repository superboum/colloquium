...
Le développement de cette étude pratique nous a permis de nous mettre en situation d?une gestion de projet, étape essentielle dans la vie d?un élève-ingénieur. Nous avons expérimenté le développement en groupe, mais nous avons pu également aborder la relation client.

En effet, durant notre étude pratique, nous avons dû apprendre à travailler avec un client qui n?est pas expert en informatique. Cela a commencé par comprendre les besoins de notre client, ici à l'occurrence M. Jean-François Dupuy, puis rechercher les technologies adaptées à son besoin. L?adoption d?une méthode agile nous a permis d?avancer en nous assurant que chaque fonctionnalité correspondait toujours à ce que M.Dupuy attendait du site web. De cette manière nous étions sûr d?avoir assimiler ce qu?il attendait de nous, et nous pouvions continuer sur une nouvelle fonctionnalité. Cela nous a aussi formé à vulgariser le langage informatique à notre encadrant.

Pour ce qui est du développement, nous avons dû d?abord appréhender plusieurs technologies informatiques en étudiant leur documentation et en les pratiquant. Nous avons également fait le nécessaire pour que chaque technologie communique avec les autres sans dysfonctionnement. La séparation des tâches nous a permis de nous focaliser chacun sur notre travail à réaliser, et aussi d?optimiser le temps d?apprentissage. En effet, nous n?étions pas obligé de maîtriser toutes les technologies ou les bibliothèques utilisées, seulement celles qui sont utilisées dans le travail personnel.

Dans les pistes à améliorer, nous aurions pu offrir au site des composantes Javascript afin de lui donner plus de dynamisme. Nous aurions pu aussi apporter un design plus attractif, le nôtre est pour ainsi dire un peu trop sobre.

Pour résumer, ce projet nous a apporté à chacun bien plus que des connaissances en informatique. Nous avons construit un système complexe composé de plusieurs technologies, tout en vérifiant en permanence que ce que l?on développe correspond au besoin de notre encadrant. Le site sera implémenté au début de l?été 2015. Nous surveillerons son utilisation avec attention, et nous devrons assurer une maintenance au moindre dysfonctionnement.
