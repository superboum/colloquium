...
\smallbreak
 Pour développer cette application, nous utilisons le langage \textit{Ruby}, auquel nous avous adjoins le framework \textit{Sinatra} et l'ORM Activerecord. Quant à l'interface, nous avons utilisé \textit{Bootstrap}. 

\smallbreak
Le site  permet à l'administrateur de créer différentes pages et article, mais aussi des événements auxquels les utilisateurs ont la possibilité de s'inscrire. Lors de son inscription, l'utilisateur les sélectionne donc. À partir de ces données, et d'information fournies, un bon de commande est généré, qui permet à l'utilisateur d'achever cette inscription.
